...
def train(args):
    ...
    # pd_train = pd.read_csv('data/train_10_no_rel_50.csv')
    ...
    if args.aug_data_dir:
        ...
        # pd_aug = pd.read_csv('./data/no_dup_10_ja_f_bt.csv')
        pd_aug = pd.read_csv('./data/enja_back_translation_train10.csv')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--aug_data_dir', type=str,
                        default='data/ja_trans_train_10.csv')
